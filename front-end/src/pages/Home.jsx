			...
			<div className="advantages-container">
				...
				<div className="row">
					...
					<div className="advantage advantage-right">
						...
						<p>Мы предлагаем интерактивно простые и понятные инструкции для легкого понимая сотрудником
							своих обязанностей и решение различных возникающих вопросов и проблем.</p>
					</div>
				</div>
				<div className="row">
					<div className="advantage">
					...
					<div className="advantage advantage-right">
						...
						<p>Мы предоставляем возможность создавать собственные информационные блоки и инструкции.
							Мы реализуем интерактивные видео для погружения сотрудника в новую среду.</p>
					</div>
				</div>
			</div>
		</div>
